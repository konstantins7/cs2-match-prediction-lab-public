...
export const importProfiles: ImportProfile[] = [
  ...
  },
  {
    ...
    validationChecklist: ["JSON only in 0.7.4", "XLSX parser future/inactive", "SQL import future/inactive", "map to parsed_demo_export canonical shape"],
  ...
  },
  {
    ...
    validationChecklist: ["JSON-first only", "no raw .dem worker in 0.7.4", "validate numeric stats", "reject raw-only payload"],
