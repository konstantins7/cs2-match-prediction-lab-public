      ...
      <div className="flex flex-wrap items-start justify-between gap-3">
        <div>
          ...
          <p className="mt-1 text-sm text-lab-muted">
            0.7.5 принимает prepared JSON через dedicated parsed demo export intake и существующие validated `manual_real` / `parsed_demo` flows. XLSX, SQL и raw .dem parser worker помечены как future/inactive.
          </p>
        </div>
